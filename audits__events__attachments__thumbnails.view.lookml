- view: audits__events__attachments__thumbnails
  sql_table_name: zd_pipeline.audits__events__attachments__thumbnails
  fields:
  ...
  - dimension: _rjm_level_2_id
    type: number
    sql: ${TABLE}._rjm_level_2_id
